					...
					<table class="table table-hover overflow-auto block">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a href="<?php echo e(route('testimonial.edit', $data->id)); ?>" class="badge badge-primary cursor-pointer">Edit</a>
								</td>
								<td>
									<?php if($isAdmin === true): ?>
									<form method="POST" action="<?php echo e(route('testimonial.destroy', $data->id)); ?>">
										...
										<?php echo csrf_field(); ?>
										<button type="submit" class="badge badge-danger cursor-pointer" onclick="return confirmDeleteReview(<?php echo e($data->id); ?> , '<?php echo e($data->name); ?>');">Delete</button>
									</form>
									<?php else: ?>
									<button onclick="alert('Only admin can delete testimonial')" class="badge badge-danger cursor-pointer">Delete</button>
									<?php endif; ?>
								</td>
							</tr>
							<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/res/resources/views/admin/pages/review/review.blade.php ENDPATH**/ ?>